...
@section('content')
    ...
    <div class="page-hero">
        ...
        <div class="page-hero-content">
            <h1 class="page-hero-title" data-aos="fade-up">Annual Functions</h1>
            <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="120">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('gallery-annual-functions.get') }}">Gallery</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Annual Functions</li>
                </ol>
            </nav>
        </div>
                ...
                @foreach ($albums as $index => $album)
                    @if (!$album->images->isEmpty())
                        <div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="{{ ($index % 6) * 80 }}">
                            <a href="{{ route('annual-functions.images.show', $album->id) }}" class="gallery-album-card">
