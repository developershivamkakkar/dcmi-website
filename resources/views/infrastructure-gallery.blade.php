@extends('layouts.app')
@section('title', 'Infrastructure Gallery')
...
@section('content')
    ...
    <div class="page-hero">
        ...
        <div class="page-hero-content">
            <h1 class="page-hero-title" data-aos="fade-up">Infrastructure</h1>
            <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="120">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('gallery-infrastructure.get') }}">Gallery</a></li>
