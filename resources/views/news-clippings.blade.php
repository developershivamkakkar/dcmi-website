@extends('layouts.app')
@section('title', 'News Clippings Gallery')
...
@section('content')
    ...
    <div class="page-hero">
        ...
        <div class="page-hero-content">
            <h1 class="page-hero-title" data-aos="fade-up">News Clippings</h1>
            <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="120">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('gallery-news-clippings.get') }}">Gallery</a></li>
        ...
        <div class="row g-4">
                ...
                @foreach ($albums as $index => $album)
                    @if (!$album->images->isEmpty())
                        <div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="{{ ($index % 6) * 80 }}">
                            <a href="{{ route('images.show', $album->id) }}" class="gallery-album-card">
            ...
            @else
                <div class="col-12 text-center py-5">
                    ...
                    <p class="text-muted">No news clippings found.</p>
                </div>
            @endif
        </div>
    </div>
